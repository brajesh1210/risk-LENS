...
1. **Ingestion Layer:** Multi-input parser for manual entry, `package.json`, or JSON/SBOM files.
2. **Threat Intel Engine:** Live querying via Google OSV API for zero-day and historical CVEs.
3. **Visualization Engine:** Interactive mapping of direct vs. transitive dependencies to calculate the blast radius.
4. **Remediation Layer:** Gemini AI intercepts high-risk nodes to generate safe library alternatives and patch scripts.
